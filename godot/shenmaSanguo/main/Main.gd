...
func _inject_test_payload() -> void:
	var test_payload: Dictionary = {
		...
		"map": {
			...
			"path_json": {
				"paths": [
					{ "id": "path_a", "waypoints": [[5,0],[5,3],[3,3],[3,7],[7,7],[7,10],[5,10]] }
				],
				"spawn": [{ "path": "path_a", "pos": [5,0] }],
				"base": [5,10],
				"build_zones": [
					[2,0],[3,0],[4,0],[6,0],[7,0],
					[0,1],[1,1],[2,1],[3,1],[4,1],[6,1],[7,1],[8,1],
					[0,2],[1,2],[2,2],[3,2],[4,2],[6,2],[7,2],[8,2],[9,2],
					[0,3],[1,3],[2,3],[6,3],[7,3],[8,3],[9,3],[10,3],
					[0,4],[1,4],[2,4],[4,4],[5,4],[6,4],[7,4],[8,4],[9,4],[10,4],
					[1,5],[2,5],[4,5],[5,5],[6,5],[7,5],[8,5],
					[1,6],[2,6],[4,6],[5,6],[6,6],[7,6],[8,6],
					[0,7],[1,7],[2,7],[8,7],[9,7],[10,7],
					[0,8],[1,8],[2,8],[3,8],[4,8],[5,8],[6,8],[8,8],[9,8],[10,8],
					[0,9],[1,9],[2,9],[3,9],[4,9],[5,9],[6,9],[8,9],[9,9],[10,9],
					[0,10],[1,10],[2,10],[3,10],[4,10],[8,10],[9,10],[10,10],
					[2,11],[3,11],[4,11],[5,11],[6,11],[7,11],[8,11]
				],
				"obstacles": [
					[0,0],[1,0],[8,0],[9,0],[10,0],
					[9,1],[10,1],
					[10,2],
					[0,5],[9,5],[10,5],
					[0,6],[9,6],[10,6],
					[0,11],[1,11],[9,11],[10,11]
				],
				"tile_textures": {
