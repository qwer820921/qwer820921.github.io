var Godot = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      return locateFile("godot.web.template_debug.wasm32.nothreads.wasm");
    }
    ...
    function assignWasmExports(wasmExports) {
      _free = Module["_free"] = wasmExports["qf"];
      __Z14godot_web_mainiPPc = Module["__Z14godot_web_mainiPPc"] =
        wasmExports["rf"];
      _main = Module["_main"] = wasmExports["sf"];
      _malloc = Module["_malloc"] = wasmExports["tf"];
      _fflush = wasmExports["uf"];
      __emwebxr_on_input_event = Module["__emwebxr_on_input_event"] =
        wasmExports["vf"];
      __emwebxr_on_simple_event = Module["__emwebxr_on_simple_event"] =
        wasmExports["wf"];
      ___funcs_on_exit = wasmExports["yf"];
      _emscripten_builtin_memalign = wasmExports["zf"];
      __emscripten_timeout = wasmExports["Af"];
      __emscripten_stack_restore = wasmExports["Bf"];
      __emscripten_stack_alloc = wasmExports["Cf"];
      _emscripten_stack_get_current = wasmExports["Df"];
      memory = wasmMemory = wasmExports["of"];
      __indirect_function_table = wasmTable = wasmExports["xf"];
    }
    var wasmImports = {
      Oc: ___call_sighandler,
      fd: ___syscall_chdir,
      Za: ___syscall_chmod,
      gd: ___syscall_faccessat,
      dd: ___syscall_fchmod,
      U: ___syscall_fcntl64,
      cd: ___syscall_fstat64,
      _c: ___syscall_ftruncate64,
      Zc: ___syscall_getcwd,
      Nc: ___syscall_getdents64,
      Aa: ___syscall_ioctl,
      ad: ___syscall_lstat64,
      Uc: ___syscall_mkdirat,
      Tc: ___syscall_mknodat,
      $c: ___syscall_newfstatat,
      Xa: ___syscall_openat,
      Mc: ___syscall_readlinkat,
      Kc: ___syscall_renameat,
      Ta: ___syscall_rmdir,
      bd: ___syscall_stat64,
      Jc: ___syscall_statfs64,
      Ic: ___syscall_symlinkat,
      Ua: ___syscall_unlinkat,
      hd: __abort_js,
      Qc: __emscripten_runtime_keepalive_clear,
      Rc: __gmtime_js,
      Sc: __localtime_js,
      Fc: __setitimer_js,
      id: __tzset_js,
      ...
      Pa: _emscripten_webgl_commit_frame,
      bc: _emscripten_webgl_create_context,
      Lb: _emscripten_webgl_destroy_context,
      $b: _emscripten_webgl_enable_extension,
      vd: _emscripten_webgl_get_supported_extensions,
      ac: _emscripten_webgl_make_context_current,
      Xc: _environ_get,
      Yc: _environ_sizes_get,
      Ka: _exit,
      na: _fd_close,
      Va: _fd_fdstat_get,
      _a: _fd_read,
      ...
      L: _glBlendEquation,
      ia: _glBlendFunc,
      C: _glBlendFuncSeparate,
      la: _glBlitFramebuffer,
      h: _glBufferData,
      R: _glBufferSubData,
      ...
      S: _glColorMask,
      fb: _glCompileShader,
      od: _glCompressedTexImage2D,
      qd: _glCompressedTexImage3D,
      pd: _glCompressedTexSubImage3D,
      rd: _glCopyBufferSubData,
      Bd: _glCreateProgram,
      hb: _glCreateShader,
      ma: _glCullFace,
      m: _glDeleteBuffers,
      ...
      E: _glDrawArrays,
      T: _glDrawArraysInstanced,
      ha: _glDrawBuffers,
      I: _glDrawElements,
      J: _glDrawElementsInstanced,
      q: _glEnable,
      o: _glEnableVertexAttribArray,
      ea: _glEndTransformFeedback,
      nb: _glFenceSync,
      Jd: _glFinish,
      ...
      kd: _glGenerateMipmap,
      td: _glGetFloatv,
      ud: _glGetInteger64v,
      aa: _glGetIntegerv,
      wd: _glGetProgramInfoLog,
      cb: _glGetProgramiv,
      eb: _glGetShaderInfoLog,
      ra: _glGetShaderiv,
      Z: _glGetString,
      Td: _glGetSynciv,
      Ed: _glGetUniformBlockIndex,
      Ea: _glGetUniformLocation,
      yd: _glLinkProgram,
      Ba: _glPixelStorei,
      Hd: _glReadBuffer,
      Ca: _glReadPixels,
      Md: _glRenderbufferStorage,
      ...
      Ga: _glTexStorage2D,
      $a: _glTexSubImage3D,
      zd: _glTransformFeedbackVaryings,
      i: _glUniform1f,
      D: _glUniform1i,
      Cd: _glUniform1iv,
      s: _glUniform1ui,
      ...
      M: _glUniform4f,
      A: _glUniform4fv,
      Dd: _glUniformBlockBinding,
      ib: _glUniformMatrix3fv,
      H: _glUniformMatrix4fv,
      l: _glUseProgram,
      ua: _glVertexAttrib4f,
      $: _glVertexAttribDivisor,
      mb: _glVertexAttribI4ui,
      da: _glVertexAttribIPointer,
      r: _glVertexAttribPointer,
      y: _glViewport,
      Ie: _godot_audio_get_sample_playback_position,
      xd: _godot_audio_has_script_processor,
      Id: _godot_audio_has_worklet,
      mf: _godot_audio_init,
      yc: _godot_audio_input_start,
      rc: _godot_audio_input_stop,
      nf: _godot_audio_is_available,
      pa: _godot_audio_resume,
      Sd: _godot_audio_sample_bus_add,
      Rd: _godot_audio_sample_bus_move,
      Zd: _godot_audio_sample_bus_remove,
      ge: _godot_audio_sample_bus_set_count,
      Kd: _godot_audio_sample_bus_set_mute,
      Od: _godot_audio_sample_bus_set_send,
      Ld: _godot_audio_sample_bus_set_solo,
      Nd: _godot_audio_sample_bus_set_volume_db,
      Te: _godot_audio_sample_is_active,
      Yb: _godot_audio_sample_register_stream,
      Pd: _godot_audio_sample_set_finished_callback,
      af: _godot_audio_sample_set_pause,
      pe: _godot_audio_sample_set_volumes_linear,
      Fb: _godot_audio_sample_start,
      lf: _godot_audio_sample_stop,
      hc: _godot_audio_sample_stream_is_registered,
      Nb: _godot_audio_sample_unregister_stream,
      ze: _godot_audio_sample_update_pitch_scale,
      sd: _godot_audio_script_create,
      nd: _godot_audio_script_start,
      Gd: _godot_audio_worklet_create,
      Ad: _godot_audio_worklet_start_no_threads,
      gc: _godot_js_config_canvas_id_get,
      Ke: _godot_js_config_locale_get,
      Se: _godot_js_display_alert,
      sc: _godot_js_display_canvas_focus,
      tc: _godot_js_display_canvas_is_focused,
      ic: _godot_js_display_clipboard_get,
      jc: _godot_js_display_clipboard_set,
      vc: _godot_js_display_cursor_is_hidden,
      uc: _godot_js_display_cursor_is_locked,
      xa: _godot_js_display_cursor_lock_set,
      Sa: _godot_js_display_cursor_set_custom_shape,
      wc: _godot_js_display_cursor_set_shape,
      ya: _godot_js_display_cursor_set_visible,
      Eb: _godot_js_display_desired_size_set,
      Qb: _godot_js_display_fullscreen_cb,
      Db: _godot_js_display_fullscreen_exit,
      Cb: _godot_js_display_fullscreen_request,
      cc: _godot_js_display_has_webgl,
      ec: _godot_js_display_is_swap_ok_cancel,
      Ob: _godot_js_display_notification_cb,
      Hb: _godot_js_display_pixel_ratio_get,
      Ib: _godot_js_display_screen_dpi_get,
      Jb: _godot_js_display_screen_size_get,
      fc: _godot_js_display_setup_canvas,
      Vc: _godot_js_display_size_update,
      qc: _godot_js_display_touchscreen_is_available,
      Kb: _godot_js_display_tts_available,
      Oa: _godot_js_display_vk_available,
      Mb: _godot_js_display_vk_cb,
      oc: _godot_js_display_vk_hide,
      pc: _godot_js_display_vk_show,
      Pb: _godot_js_display_window_blur_cb,
      Qa: _godot_js_display_window_icon_set,
      Na: _godot_js_display_window_size_get,
      Gb: _godot_js_display_window_title_set,
      Ue: _godot_js_emscripten_get_version,
      $e: _godot_js_eval,
      Ab: _godot_js_fetch_create,
      Ma: _godot_js_fetch_free,
      xb: _godot_js_fetch_http_status_get,
      zb: _godot_js_fetch_is_chunked,
      yb: _godot_js_fetch_read_chunk,
      kf: _godot_js_fetch_read_headers,
      wa: _godot_js_fetch_state_get,
      Tb: _godot_js_input_drop_files_cb,
      Sb: _godot_js_input_gamepad_cb,
      Bb: _godot_js_input_gamepad_sample,
      lc: _godot_js_input_gamepad_sample_count,
      kc: _godot_js_input_gamepad_sample_get,
      Vb: _godot_js_input_key_cb,
      _b: _godot_js_input_mouse_button_cb,
      Zb: _godot_js_input_mouse_move_cb,
      Xb: _godot_js_input_mouse_wheel_cb,
      Ub: _godot_js_input_paste_cb,
      Wb: _godot_js_input_touch_cb,
      Me: _godot_js_input_vibrate_handheld,
      Ra: _godot_js_is_ime_focused,
      Ye: _godot_js_os_download_buffer,
      Qe: _godot_js_os_execute,
      vb: _godot_js_os_finish_async,
      He: _godot_js_os_fs_is_persistent,
      Re: _godot_js_os_fs_sync,
      Oe: _godot_js_os_has_feature,
      Pe: _godot_js_os_hw_concurrency_get,
      dc: _godot_js_os_request_quit_cb,
      Ne: _godot_js_os_shell_open,
      Je: _godot_js_pwa_cb,
      Le: _godot_js_pwa_update,
      ub: _godot_js_rtc_datachannel_close,
      xe: _godot_js_rtc_datachannel_connect,
      ue: _godot_js_rtc_datachannel_destroy,
      ye: _godot_js_rtc_datachannel_get_buffered_amount,
      De: _godot_js_rtc_datachannel_id_get,
      Ae: _godot_js_rtc_datachannel_is_negotiated,
      Ee: _godot_js_rtc_datachannel_is_ordered,
      we: _godot_js_rtc_datachannel_label_get,
      Ce: _godot_js_rtc_datachannel_max_packet_lifetime_get,
      Be: _godot_js_rtc_datachannel_max_retransmits_get,
      ve: _godot_js_rtc_datachannel_protocol_get,
      Ge: _godot_js_rtc_datachannel_ready_state_get,
      Fe: _godot_js_rtc_datachannel_send,
      tb: _godot_js_rtc_pc_close,
      oe: _godot_js_rtc_pc_create,
      ne: _godot_js_rtc_pc_datachannel_create,
      sb: _godot_js_rtc_pc_destroy,
      qe: _godot_js_rtc_pc_ice_candidate_add,
      se: _godot_js_rtc_pc_local_description_set,
      te: _godot_js_rtc_pc_offer_create,
      re: _godot_js_rtc_pc_remote_description_set,
      nc: _godot_js_set_ime_active,
      Rb: _godot_js_set_ime_cb,
      mc: _godot_js_set_ime_position,
      Cc: _godot_js_tts_get_voices,
      Dc: _godot_js_tts_is_paused,
      Ec: _godot_js_tts_is_speaking,
      Ac: _godot_js_tts_pause,
      zc: _godot_js_tts_resume,
      Bc: _godot_js_tts_speak,
      xc: _godot_js_tts_stop,
      Wa: _godot_js_webmidi_close_midi_inputs,
      jd: _godot_js_webmidi_open_midi_inputs,
      ke: _godot_js_websocket_buffered_amount,
      je: _godot_js_websocket_close,
      me: _godot_js_websocket_create,
      rb: _godot_js_websocket_destroy,
      le: _godot_js_websocket_send,
      df: _godot_js_wrapper_create_cb,
      bf: _godot_js_wrapper_create_object,
      cf: _godot_js_wrapper_interface_get,
      ff: _godot_js_wrapper_object_call,
      hf: _godot_js_wrapper_object_get,
      wb: _godot_js_wrapper_object_getvar,
      _e: _godot_js_wrapper_object_is_buffer,
      jf: _godot_js_wrapper_object_set,
      ef: _godot_js_wrapper_object_set_cb_ret,
      gf: _godot_js_wrapper_object_setvar,
      ...
      fe: _godot_webxr_get_bounds_geometry,
      Xd: _godot_webxr_get_color_texture,
      Wd: _godot_webxr_get_depth_texture,
      ee: _godot_webxr_get_frame_rate,
      Yd: _godot_webxr_get_projection_for_view,
      _d: _godot_webxr_get_render_target_size,
      ce: _godot_webxr_get_supported_frame_rates,
      pb: _godot_webxr_get_transform_for_view,
      Vd: _godot_webxr_get_velocity_texture,
      qb: _godot_webxr_get_view_count,
      he: _godot_webxr_get_visibility_state,
      ae: _godot_webxr_initialize,
      ie: _godot_webxr_is_session_supported,
      be: _godot_webxr_is_supported,
      $d: _godot_webxr_uninitialize,
      Ud: _godot_webxr_update_input_source,
      de: _godot_webxr_update_target_frame_rate,
      Pc: _proc_exit,
    };
