...
export const seoMap: {
  ...
  [ROUTES.WATER_COLOR_SORT]: {
    title: "子yee 萬事屋 | 水彩分類 - 極致舒壓的水彩分類益智遊戲",
    description:
      "挑戰隨關卡漸進的色彩分類難題！將試管中的繽紛液體完美歸類，享受流暢動畫與隨時可用的求救空管機制。舒壓、益智、無限關卡等待你來挑戰。",
    keywords:
      "色彩排序, 水彩分類, 益智遊戲, 色彩遊戲, 線上小遊戲, 萬事屋, Water Sort, Color Sort, 舒壓遊戲",
  },
  [ROUTES.GAME2048]: {
  ...
  [ROUTES.SUDOKU]: {
    title: "子yee 萬事屋 | 經典數獨 - 極致現代的數位邏輯挑戰",
    description:
      "挑戰從簡單到專家的四種難度數獨！享受極致現代化的 UI 設計、智慧筆記模式與順暢的操作體驗。鍛鍊腦力、突破極限，快來體驗萬事屋推出的頂級數獨遊戲。",
    keywords:
