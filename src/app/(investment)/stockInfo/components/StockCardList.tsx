          ...
          <div className="card shadow-sm border-0">
            <div className="card-header bg-white d-flex justify-content-between align-items-center py-3 border-0">
              <h5 className="mb-0 fw-bold text-dark">
                {stock.n} <small className="text-muted fw-normal">({stock.c})</small>
              </h5>
              <button
                    ...
                    >
                      <div className="d-flex w-100 justify-content-between pe-3">
                        <div className="fw-bold">
                            最新價: <span className="ms-1">{formatPrices(stock.currentPrice?.toString()) || "-"}</span>
                        </div>
                        <div
                          className={
                        ...
                        >
                          {(stock.changePercent ?? 0) > 0 ? "▲" : (stock.changePercent ?? 0) < 0 ? "▼" : ""}
                  ...
                  >
                    <div className="accordion-body px-0 py-2 border-top">
                      ...
                      <DetailRow 
                        ...
                        color={ (stock.changePoints ?? 0) > 0 ? "#dc3545" : (stock.changePoints ?? 0) < 0 ? "#198754" : "inherit" }
                      />
                      ...
                      <div className="row mt-3 g-2">
                        <div className="col-6">
                            <div className="bg-light p-2 rounded">
                                <div className="fw-bold small mb-1 text-primary">五檔買價 (數量)</div>
                                <div style={{ fontSize: "0.75rem" }}>
                                    {stock.bidCombined?.map((item, i) => (
                                        <div key={i} className="py-1 border-bottom-dashed text-nowrap">{item}</div>
                                    ))}
                                </div>
                            </div>
                        </div>
                        <div className="col-6">
                            <div className="bg-light p-2 rounded">
                                <div className="fw-bold small mb-1 text-danger">五檔賣價 (數量)</div>
                                <div style={{ fontSize: "0.75rem" }}>
